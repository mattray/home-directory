...
;; Matt Ray's color theme, reusing the ir-black code and a few colors
;; mostly adapted from color-theme-deep-blue

(defun color-theme-mattray ()
  (interactive)
